...
<jsp:include page="../sub_header.jsp" />
 <!-- Header -->
    <a name="about"></a>
    <div class="intro-header subImg01">
        <div class="container">
	...
	<div class="container">
		<div class="about_sub" id="tabs">
		    <dl>
		    	<dt><span>About</span></dt>
		    	<dd id="tabs-1">
			    <p style="background: url(../../img/logo+fork_width.png) no-repeat; background-position: right top;">
			    	맛있는 이태리 레스토랑, YUM YUM!<br>
		    ...
		    <dl>
			    ...
			    <p>
			    	인사말<br>
			    	인사말인사아니사인사 인사말인사아니사인사 인사말인사아니사인사 <br>
			    	인사말인사아니사인사 인사말인사아니사인사 인사말인사아니사인사 <br>
			    	인사말인사아니사인사 인사말인사아니사인사 인사말인사아니사인사 <br>
			    	인사말인사아니사인사 인사말인사아니사인사 인사말인사아니사인사 <br>
			    	인사말인사아니사인사 인사말인사아니사인사 인사말인사아니사인사 <br>
