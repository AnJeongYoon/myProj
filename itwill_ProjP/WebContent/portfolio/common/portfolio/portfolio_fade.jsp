                        ...
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p>
	                                ...
	                                is a website builder for professionals. Startup Framework contains components and complex blocks 
	                                (PSD+HTML Bootstrap themes and templates) which can easily be integrated into almost any design. 
