...
String path ="C:/Users/itwillbs06-04/git/doTeam/projectTForgit/WebContent/TeamProj/common/board/uploadFolder"; // 이미지가 저장될 주소 학원에서!!
...
<%
	...
	try {
		...
		if (!upfile.equals("")) {
			...
			//String moveFileName = dateString + upfile + "_" + upfile.substring(upfile.lastIndexOf(".") );
