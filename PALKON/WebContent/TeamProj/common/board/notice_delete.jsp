...
<div class="main">
	...
	<div class="col-md-12 col-sm-12">
            ...
            <div class="content-form-page">
              <form action="../notice_delete_action.no?pageNum=<%=pageNum %>" method="post" class="form-horizontal form-without-legend" id="form" name="f">
               ...
               <input type="hidden" name="num" value="<%=num%>"> 
	            ...
	            <div class="boardBtn2">
		     		...
		     		<input type="submit" id="deleteBtn" name="deleteBtn" value="삭제" onclick="loaction.href='../notice_delete_action.no'">
